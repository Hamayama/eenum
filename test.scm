...
(expr-test "" "0.0123e4"  (eenum "123"     :en -1))
(expr-test "" "0.123e3"   (eenum "123"     :en  0))
(expr-test "" "1.23e2"    (eenum "123"     :en  1))
(expr-test "" "12.3e1"    (eenum "123"     :en  2))
(expr-test "" "1.23456e2" (eenum "123.456" :en  #t))
(expr-test "" "1.2346e2"  (eenum "123.456" :d 4 :rm 'round2 :en #t))
(expr-test "" "0.10e4"    (eenum  999.999  :d 2 :rm 'round2 :en 0))
(expr-test "" "-0.10e4"   (eenum -999.999  :d 2 :rm 'round2 :en 0))
