...
(expr-test "" "120"      (eenum "123.456"  #f -1 #f #f 'truncate))
(expr-test "" "123"      (eenum "123.456"  #f  0 #f #f 'truncate))
(expr-test "" "123.4"    (eenum "123.456"  #f  1 #f #f 'truncate))
(expr-test "" "123.45"   (eenum "123.456"  #f  2 #f #f 'truncate))
(expr-test "" "-120"     (eenum "-123.456" #f -1 #f #f 'truncate))
(expr-test "" "-123"     (eenum "-123.456" #f  0 #f #f 'truncate))
(expr-test "" "-123.4"   (eenum "-123.456" #f  1 #f #f 'truncate))
(expr-test "" "-123.45"  (eenum "-123.456" #f  2 #f #f 'truncate))
(test-section "round-mode 'floor")
(expr-test "" "120"      (eenum "123.456"  #f -1 #f #f 'floor))
(expr-test "" "123"      (eenum "123.456"  #f  0 #f #f 'floor))
(expr-test "" "123.4"    (eenum "123.456"  #f  1 #f #f 'floor))
(expr-test "" "123.45"   (eenum "123.456"  #f  2 #f #f 'floor))
(expr-test "" "-130"     (eenum "-123.456" #f -1 #f #f 'floor))
(expr-test "" "-124"     (eenum "-123.456" #f  0 #f #f 'floor))
(expr-test "" "-123.5"   (eenum "-123.456" #f  1 #f #f 'floor))
(expr-test "" "-123.46"  (eenum "-123.456" #f  2 #f #f 'floor))
(test-section "round-mode 'ceiling")
(expr-test "" "130"      (eenum "123.456"  #f -1 #f #f 'ceiling))
(expr-test "" "124"      (eenum "123.456"  #f  0 #f #f 'ceiling))
(expr-test "" "123.5"    (eenum "123.456"  #f  1 #f #f 'ceiling))
(expr-test "" "123.46"   (eenum "123.456"  #f  2 #f #f 'ceiling))
(expr-test "" "-120"     (eenum "-123.456" #f -1 #f #f 'ceiling))
(expr-test "" "-123"     (eenum "-123.456" #f  0 #f #f 'ceiling))
(expr-test "" "-123.4"   (eenum "-123.456" #f  1 #f #f 'ceiling))
(expr-test "" "-123.45"  (eenum "-123.456" #f  2 #f #f 'ceiling))
(test-section "round-mode 'round")
(expr-test "" "120"      (eenum "123.456"  #f -1 #f #f 'round))
(expr-test "" "123"      (eenum "123.456"  #f  0 #f #f 'round))
(expr-test "" "123.5"    (eenum "123.456"  #f  1 #f #f 'round))
(expr-test "" "123.46"   (eenum "123.456"  #f  2 #f #f 'round))
(expr-test "" "-120"     (eenum "-123.456" #f -1 #f #f 'round))
(expr-test "" "-123"     (eenum "-123.456" #f  0 #f #f 'round))
(expr-test "" "-123.5"   (eenum "-123.456" #f  1 #f #f 'round))
(expr-test "" "-123.46"  (eenum "-123.456" #f  2 #f #f 'round))
(expr-test "" "123.0"    (eenum "123.05"   #f  1 #f #f 'round))
(expr-test "" "123.2"    (eenum "123.15"   #f  1 #f #f 'round))
(expr-test "" "124.0"    (eenum "123.95"   #f  1 #f #f 'round))
(expr-test "" "-123.0"   (eenum "-123.05"  #f  1 #f #f 'round))
(expr-test "" "-123.2"   (eenum "-123.15"  #f  1 #f #f 'round))
(expr-test "" "-124.0"   (eenum "-123.95"  #f  1 #f #f 'round))
(expr-test "" "123.0"    (eenum "123.050"  #f  1 #f #f 'round))
(expr-test "" "123.2"    (eenum "123.150"  #f  1 #f #f 'round))
(expr-test "" "124.0"    (eenum "123.950"  #f  1 #f #f 'round))
(expr-test "" "-123.0"   (eenum "-123.050" #f  1 #f #f 'round))
(expr-test "" "-123.2"   (eenum "-123.150" #f  1 #f #f 'round))
(expr-test "" "-124.0"   (eenum "-123.950" #f  1 #f #f 'round))
(expr-test "" "1000.00"  (eenum "999.995"  #f  2 #f #f 'round))
(expr-test "" "-1000.00" (eenum "-999.995" #f  2 #f #f 'round))
(test-section "round-mode 'round2")
(expr-test "" "120"      (eenum "123.456"  #f -1 #f #f 'round2))
(expr-test "" "123"      (eenum "123.456"  #f  0 #f #f 'round2))
(expr-test "" "123.5"    (eenum "123.456"  #f  1 #f #f 'round2))
(expr-test "" "123.46"   (eenum "123.456"  #f  2 #f #f 'round2))
(expr-test "" "-120"     (eenum "-123.456" #f -1 #f #f 'round2))
(expr-test "" "-123"     (eenum "-123.456" #f  0 #f #f 'round2))
(expr-test "" "-123.5"   (eenum "-123.456" #f  1 #f #f 'round2))
(expr-test "" "-123.46"  (eenum "-123.456" #f  2 #f #f 'round2))
